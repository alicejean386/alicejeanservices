...
function resizeComponents(){if(global.printBody)printBody.onResize();if(global.downLoadBody)downLoadBody.onResize();if(global.helpBody)helpBody.onResize();if(global.aboutBody)aboutBody.onResize();if(global.sharePanel)sharePanel.onResize();if(global.languagePanel)languagePanel.onResize();if(global.frmTableOfContent)frmTableOfContent.onResize();if(global.bookmark)bookmark.onResize();if(bookConfig.AnnotationButtonVisible&&global.annotationPannel)global.annotationPannel.onResize()};var PcAboutForm=Class({create:function(a){this.elements=new AboutElements(this);this._super(a)},onCreate:function(){this.initColorCss();this._super();this.bookReadTimesVisible()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.95),color:this.fontColor})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='about_content'></div>");
this.stage.append(this.content);this.content2=$("<div class='content2'></div>");this.content.append(this.content2);this.initSwiper();this.content2.append(this.aboutSwiper);this.content1=$("<div class='content1'></div>");this.content.append(this.content1);this.content1.append(this.author);this.content1.append(this.address);this.content1.append(this.email);this.content1.append(this.website);this.content1.append(this.mobile);this.initLogo();this._super()},bookReadTimesVisible:function(){var a=setInterval(function(){try{this.ReadTimes=
...
this.aboutSwiper.append(this.progress);this.progress.append(this.progressBar);this.aboutSwiper.scroll({},Direction.top,"win10")},onResize:function(){this._super();200<=this.aboutSwiperList.height()&&this.aboutSwiper.css({height:"200px"})},onShow:function(){this.changeIconColor();this.aboutSwiper.refreshData()},initLogo:function(){bookConfig.AboutDescription?this.aboutSwiper.css({display:"block"}):this.aboutSwiper.css({display:"none"});this.content2.find(this.logo)[0]||(this.content2.prepend(this.logo),
bookConfig.AboutWebsite&&this.logo.attr("href",bookConfig.AboutWebsite))}}).extend(SlideRightForm);var PcBookmarkItem=Class({create:function(a,b){this.mainColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;a.fontColor=this.fontColor;this._super(a,b)},initHtml:function(){rightToLeft?this.initRightToLeftHtml():this.initLeftToRightHtml();this.deleteIcon.changeButtonColor(this.mainColor);this.edit.changeButtonColor(this.mainColor);this.cancel.changeButtonColor(this.mainColors);
this.save.changeButtonColor(this.mainColor);this.initColorOrder(this.item);this.itemImg=$("<div class='itemImg' ></div>");this.item.append(this.itemImg);this.item.css({border:"1px solid "+Color(this.mainColor).add(32),background:Color(this.mainColor).add(64)});this.refreshImage()},refreshImage:function(){var a=this;getPageDir(this.pageCaption,"thumb",originTotalPageCount).then(function(b){b.match(/^none/)?a.itemImg.css({background:bookConfig.pageBackgroundColor}):a.itemImg.css({background:"transparent url("+
b+") center center / contain no-repeat"})})},resetColor:function(){for(var a="#66D566 #64D3ED #9D80D7 #ED8383 #ED9933 #A6A19B #3398ED".split(" "),b=0;b<a.length;b++)this.colorOrder.find(".item"+b).css({"background-image":"radial-gradient("+a[b]+" 40%,transparent 48%,transparent 53%,transparent 63%)"}),this.colorOrder.find(".item"+b).removeClass("active")},setElemColor:function(a){this.colorSelection.attr("color",a);this.colorSelection.css({background:a})},saveData:function(){var a=this.colorSelection.attr("color"),
b=this.title.val();if(b!=this.caption||a!=this.color)this.caption=b,this.color=a,this.parm={pageIndex:this.pageIndex,caption:this.caption,color:this.color},this.callback.editItem(this.parm)},initColorOrder:function(a){var b="#66D566 #64D3ED #9D80D7 #ED8383 #ED9933 #A6A19B #3398ED".split(" ");this.colorOrder=$("<div class='color_order' ></div>");for(var c=0;c<b.length;c++){var d=$("<div class='color_item item"+c+"' color='"+b[c]+"' ></div>");d.css({cursor:"pointer","background-image":"radial-gradient("+
b[c]+" 40%,transparent 48%,transparent 53%,transparent 63%)"});(function(e,g,f){g.bind("click",function(){e.resetColor(e.colorOrder);g.addClass("active");e.setElemColor(f);g.css({"background-image":"radial-gradient("+f+" 40%, transparent 48%, transparent 53%,"+f+" 63%)"})}.bind(e))})(this,d,b[c]);this.colorOrder.append(d)}a.append(this.colorOrder);this.colorSelection.bind(_event._click,function(){this.resetColor()}.bind(this))},lightItem:function(){$(".bookmarkItem_focus").removeClass("bookmarkItem_focus");
this.item.addClass("bookmarkItem_focus")},startEdit:function(){this.judgeToSaveOrCancel();this.lightItem();this.cancel.show();this.save.show();this.edit.hide();this.title.css({background:"#ffffff",color:"#000000"});this.title.removeAttr("disabled");this.title.addClass("focus");this.item.addClass("edit");global.bookmark.editingItem=this;this.cancel.changeButtonColor(this.mainColor);this.save.changeButtonColor(this.mainColor);this.deleteIcon.hide()},cancelData:function(){var a=this.colorSelection.attr("color");
this.title.val()!=this.caption&&this.title.val(this.caption);a!=this.color&&this.setElemColor(this.color)},endEdit:function(){this._super();this.title.removeClass("focus");this.item.removeClass("edit");this.colorSelection.show();this.deleteIcon.show()}}).extend(BookmarkItem);var PcBookmarkListPanel=Class({create:function(a){this.mainColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;this.mainColorObj=Color(this.mainColor);this.fontColorObj=Color(this.fontColor);this._super(a)},onCreate:function(){},newItem:function(a){return new PcBookmarkItem(a,this.callback)}}).extend(BookmarkListPanel);var PcBookmarkForm=Class({create:function(a){this.elements=new BookmarkElements(this);this.bookmarkListPanel=new PcBookmarkListPanel(this);this.elements.bookmarkList=this.bookmarkListPanel.bookmarkList;this._super(a)},onCreate:function(){this.bookmarkListPanel.onCreate();this.setElemColor("#66D566")},resetColor:function(a){a||(a=this.colorOrder);for(var b="#66D566 #64D3ED #9D80D7 #ED8383 #ED9933 #A6A19B #3398ED".split(" "),c=0;c<b.length;c++)a.find(".item"+c).css({"background-image":"radial-gradient("+
b[c]+" 40%,transparent 48%,transparent 53%,transparent 63%)"}),a.find(".item"+c).removeClass("active")},initColorCss:function(){this.bookmarkListPanel.initColorCss();this.bookmarkListPanel.resetSwiperHtml();this.stage.css({"background-color":this.mainColorObj.rgba(.95),color:this.fontColor});this.leftAddPage.css({border:"1px solid "+Color(this.mainColor).add(32),color:this.fontColor,background:Color(this.mainColor).add(64)});this.rightAddPage.css({border:"1px solid "+Color(this.mainColor).add(32),
color:this.fontColor,background:Color(this.mainColor).add(64)});this.remove.css({border:"1px solid "+Color(this.mainColor).add(32),background:Color(this.mainColor).add(64)})},setElemColor:function(a){this.colorSelection.attr("color",a);this.colorSelection.css({background:a})},initColorOrder:function(a){var b="#66D566 #64D3ED #9D80D7 #ED8383 #ED9933 #A6A19B #3398ED".split(" ");this.colorOrder=$("<div class='color_order' style='height:22px;margin:11px 0 1px;'></div>");for(var c=0;c<b.length;c++){var d=
$("<div class='color_item item"+c+"' color='"+b[c]+"' style='cursor:pointer;width:20px;height:20px;border-radius:11px;display:inline-block;margin:0 2px;'></div>");d.css({"background-image":"radial-gradient("+b[c]+" 40%,transparent 48%,transparent 53%,transparent 63%)"});0==c&&(d.addClass("active"),d.css({"background-image":"radial-gradient("+b[c]+" 40%, transparent 48%, transparent 53%,"+b[c]+" 63%)"}));(function(e,g,f){g.bind("click",function(){e.resetColor(e.colorOrder);g.addClass("active");e.setElemColor(f);
g.css({"background-image":"radial-gradient("+f+" 40%, transparent 48%, transparent 53%,"+f+" 63%)"})}.bind(e))})(this,d,b[c]);this.colorOrder.append(d)}a.append(this.colorOrder);this.colorSelection.bind(_event._click,function(){this.resetColor()}.bind(this))},onResize:function(){this._super();var a=windowHeight;this.stage.find(".bookmark_content").css({height:a-87+"px"});toolBar.getTopHeight();this.width=240;this.height=a-20;this.stage.css({height:this.height+"px"});this.bookmarkListPanel.onResize(this.width,
this.height-215);this.refreshPanel()},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='bookmark_content'></div>");this.stage.append(this.content);var a=$("<p class='inputForm'></p>");a.append(this.input);a.append(this.colorSelection);this.content.append(a);this.initColorOrder(this.content);this.content.append(this.leftAddPage);this.content.append(this.rightAddPage);
this.content.append(this.bookmarkListPanel.bookmarkListTitle);this.content.append(this.bookmarkListPanel.bookmarkSwiper);this.content.append(this.remove);this.parent.append(this.stage);this.stage.css({background:Color(this.mainColor).rgba(.95),color:Color(this.fontColor)});this.leftAddPage.css({border:"1px solid "+Color(this.mainColor).add(32),background:Color(this.mainColor).add(64)});this.rightAddPage.css({border:"1px solid "+Color(this.mainColor).add(32),background:Color(this.mainColor).add(64)});
this.remove.css({border:"1px solid "+Color(this.mainColor).add(32),background:Color(this.mainColor).add(64)});this.refreshPanel()},refreshPanel:function(){this.bookmarkListPanel.refreshPanel();this.elements.refreshElements()},addItem:function(a){a&&a.caption&&a.pageIndex&&!this.bookmarkListPanel.inList(a.pageIndex)&&(this.bookmarkListPanel.addItem(a),this.input.val(""),this.setRandom(),this.refreshPanel())},setRandom:function(){this.resetColor();var a=getRandomColor();this.colorSelection.attr("color",
a);this.colorSelection.css("background",a)},deleteItem:function(a){this.bookmarkListPanel.deleteItem(a);this.refreshPanel()},editItem:function(a){this.bookmarkListPanel.editItem(a);this.refreshPanel()},refreshItem:function(a){this.bookmarkListPanel.refreshItem(a)},removeAll:function(){this.bookmarkListPanel.removeAll();this.refreshPanel()},onShow:function(){this.close.changeButtonColor(this.fontColor);this.favicon&&this.favicon.changeButtonColor(this.fontColor);this.refreshItemsImage()},refreshItemsImage:function(){this.bookmarkListPanel.refreshItemsImage()}}).extend(SlideRightForm);var PcHelpForm=Class({create:function(a){this.elements=new HelpElements(this);this._super(a)},onCreate:function(){this.stage.css({"background-color":this.mainColor,color:this.fontColor});bookConfig.helpContentFileURL&&(this.stage.css({width:bookConfig.helpWidth+"px",height:windowHeight+"px"}),this.content.css({width:bookConfig.helpWidth-30+"px",height:bookConfig.helpHeight-59+"px"}),this.image.css({background:"url("+bookConfig.helpContentFileURL+") center no-repeat","background-size":"contain",width:bookConfig.helpWidth-
30+"px",height:bookConfig.helpWidth-30+"px"}));this._super();bookConfig.showHelpContentAtFirst?this.show():this.hide()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.95),color:this.fontColor})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.content=$("<div class='help_content'></div>");this.stage.append(this.content);this.content.append(this.image);
this.title1&&this.content.append(this.title1);this.title2&&this.content.append(this.title2);this._super()},onShow:function(){this.close.changeButtonColor(this.fontColor);this.favicon&&this.favicon.changeButtonColor(this.fontColor);this.image.changeButtonColor(this.fontColor)}}).extend(SlideRightForm);var PcPrintForm=Class({create:function(a){this.elements=new PrintElements(this);this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.95),color:this.fontColor})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.appendPrintOptions();this.stage.css({background:Color(this.mainColor).rgba(.95*
this.formOpacity),color:Color(this.fontColor)});this.setColor();this._super()},setColor:function(){this.printCurrent.css({border:"1px solid "+Color(this.mainColor).add(32),"background-color":Color(this.mainColor).add(64)});this.printRange.css({border:"1px solid "+Color(this.mainColor).add(32),"background-color":Color(this.mainColor).add(64)});this.printAll.css({border:"1px solid "+Color(this.mainColor).add(32),"background-color":Color(this.mainColor).add(64)});this.printButton.css({border:"1px solid "+
Color(this.mainColor).add(32),"background-color":Color(this.mainColor).add(64)})},onResize:function(){this._super();this.stage.css({height:this.height+"px",top:"0"})},changeItemColor:function(){this.printCurrent.changeButtonColor(this.fontColor);this.printRange.changeButtonColor(this.fontColor);this.printAll.changeButtonColor(this.fontColor)},initEvent:function(){this._super()},onShow:function(){this.close.changeButtonColor(this.fontColor);this.favicon&&this.favicon.changeButtonColor(this.fontColor);
this.pictureListForm.leftBtn.changeButtonColor(this.fontColor);this.pictureListForm.rightBtn.changeButtonColor(this.fontColor);this.changeItemColor()},onHide:function(){},appendPrintOptions:function(){this.emptyTips=$('<div><span class="no-files-prompt" >'+getLanguage("emptyPrintOptionsTips","No printing options.")+"</span></div>");this.emptyTips.css({height:"150px",width:"100%",display:"flex","align-items":"center","justify-content":"center","font-size":"20px"});var a=this.stage;bookConfig.printOptions&&
0<bookConfig.printOptions.length?(0<=bookConfig.printOptions.indexOf("all")&&a.append(this.printAll),0<=bookConfig.printOptions.indexOf("current")&&a.append(this.printCurrent),0<=bookConfig.printOptions.indexOf("range")&&a.append(this.printRange),a.append(this.printButton)):a.append(this.emptyTips)}}).extend(SlideRightForm);var PcTableOfContentItem=Class({create:function(a,b,c){b.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.toolbarColor;this._super(a,b,c)}}).extend(TableOfContentItem);var PcTableOfContentForm=Class({create:function(a){this.elements=new TableOfContentElements(this);this._super(a)},onCreate:function(){this.initColorCss()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.95*this.formOpacity),color:this.fontColor});this.progressBar.css({"background-color":this.fontColor})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);
this.content=$("<div class='tableofcontent_content'></div>");this.stage.append(this.content);this.content.append(this.tableofcontentSwiper);this.parent.append(this.stage)},newItem:function(a,b,c){return new PcTableOfContentItem(a,b,c)},onResize:function(){toolBar.getWidth();toolBar.getTopHeight();this.width=300;this.height=windowHeight;this.maxHeight=this.height-50;this.stage.css({height:"100%",top:0});this.tableofcontentSwiper.css({height:this.maxHeight+"px"});this.elements.refresh()},onShow:function(){this.close.changeButtonColor(this.fontColor);
this.favicon&&this.favicon.changeButtonColor(this.fontColor)}}).extend(SlideRightForm);var PcVideoGalleryForm=Class({create:function(a){this.elements=new VideoGalleryElements(this);this._super(a)},onCreate:function(){this.initColorCss();this._super()},initColorCss:function(){this.stage.css({background:this.mainColorObj.rgba(.95),color:this.fontColor})},initHtml:function(){this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.video);this.stage.append(this.info);
if(this.videoList&&1<this.videoList.length){var a=$("<div class='video_list'></div>");a.append(this.videoListTitle);a.append(this.videoSwiper);this.stage.append(a)}else this.stage.css("width","335px");this._super()},onShow:function(){this.close.changeButtonColor(this.fontColor);this.favicon&&this.favicon.changeButtonColor(this.fontColor);this.elements.playVideo(this.videoList[0]);this.videoList&&1<this.videoList.length&&this.videoSwiper.refreshData()},onHide:function(){this.video.attr("src","")}}).extend(FadeOutFadeForm);var PcShareForm=Class({create:function(a){this.elements=new ShareElements(this);this._super(a)},onCreate:function(){this.initColorCss();this._super()},initColorCss:function(){this.title.css({color:this.fontColor});this.copy1.css({color:this.mainColor});this.linkArea.css({color:this.mainColor});this.stage.css({"background-color":this.mainColorObj.rgba(.95*this.formOpacity),color:this.fontColor});this.codeBox.find(".qrcode").css({"background-color":this.mainColor,color:this.fontColor});this.codeBox.find(".miniProgram").css({"background-color":this.mainColor,
color:this.fontColor});for(var a=0;a<this.sharePanel.find("a").length;a++){var b=this.sharePanel.find("a")[a];$(b).find("span").css("color",this.mainColor)}},initHtml:function(){for(var a=this,b=0;b<this.sharePanel.find("a").length;b++){var c=this.sharePanel.find("a")[b],d=$("<span style='color:"+this.mainColor+"'>"+$(c).attr("title")+"</span>");$(c).append(d)}this.scrollStage=$("<div class='stage'></div>");this.swiper=$("<div class='swiper'></div>");this.progress=$("<div class='progress'></div>");
this.progressBar=$("<div class='progressBar'></div>");this.progress.append(this.progressBar);this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.stage.append(this.close);this.getQrCodeStatus().then(function(e){e&&a.swiper.append(a.codeBox)}).catch(function(e){console.error("Error getting QR code status:",e)});this.swiper.append(this.sharePanel).append(this.linkTitle).append(this.linkArea);this.shareCurrentPageBox.append(this.shareCurrentCheck).append(this.shareCurrentPageTitle1);
this.swiper.append(this.shareCurrentPageBox).append(this.copy1);this.scrollStage.append(this.swiper).append(this.progress);this.stage.append(this.scrollStage);this._super();this.stage.css({height:windowHeight-20+"px"});this.scrollStage.css({height:windowHeight-63+"px"});this.scrollStage.scroll({},Direction.top)},changeItemColor:function(){this.elements.fontColor=this.fontColor;this.shareCurrentCheck.changeButtonColor(this.fontColor)},onShow:function(){var a=this;this.changeItemColor();this.close.changeButtonColor(this.fontColor);
this.favicon&&this.favicon.changeButtonColor(this.fontColor);this.scrollStage.refreshData();this.elements.addItem(function(){a.stage[0].style.display="inline-block"})}}).extend(SlideRightForm);var PcDownloadForm=Class({get hasFiles(){return window.downloadconfig?!downloadconfig.hideDownloadSinglePage||downloadconfig.pdf||downloadconfig.attachments&&0<downloadconfig.attachments.length:!1},create:function(a){this.elements=new DownloadElements(this);this._super(a)},onCreate:function(){this.initColorCss();this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.95*this.formOpacity),color:this.fontColor});this.borderColor=this.mainColorObj.add(32);this.itemBgColor=
